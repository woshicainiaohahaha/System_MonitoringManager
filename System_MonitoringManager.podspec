#
#  Be sure to run `pod spec lint System_MonitoringManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "System_MonitoringManager"
  spec.version      = "0.0.1"
  spec.summary      = "这是一个iOS系统资源监测的工具."
  ...
  spec.author             = { "blogs" => "https://tree.wienli.club/#" }
  # Or just: spec.author    = "lidongyan"
  # spec.authors            = { "lidongyan" => "wienli_uid@163.com" }
  # spec.social_media_url   = "https://twitter.com/lidongyan"
